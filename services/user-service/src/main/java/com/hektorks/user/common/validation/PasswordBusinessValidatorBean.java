...
public class PasswordBusinessValidatorBean extends BusinessValidatorTemplateBean<PasswordValidationEntity> {
  ...
  @Override
  boolean appliesTo(PasswordValidationEntity entity) {
    if (entity != null) {
  ...
  @Override
  void process(PasswordValidationEntity entity) {
